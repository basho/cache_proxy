...
def __unsupported__test_linsert():
    r = getconn()
...
def __unsupported__test_lpush_lrange():
    r = getconn()
...
def __unsupported__test_hscan_large():
    r = getconn()
