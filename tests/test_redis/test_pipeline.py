...
# NOTE: despite the use of CRDT commands, this test set has none marked as __unsupported__
# as the pipeline feature under test is good to have in place as is.
